        ...
        <>
            ...
            <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
                <td className="w-48 px-5 py-3 whitespace-nowrap">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="data min-w-[150px]">
                            ...
                            <p className="font-normal text-xs leading-5 text-gray-400 whitespace-nowrap">
                                {" "}
                                {data.email}{" "}
                            </p>
                        </div>
                ...
                <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                    {" "}
                    {/* {!data.rolesName ? "User" : data.rolesName}{" "} */}
                    <Box
                        sx={{
                            minWidth: 100,
                            width: {
                    ...
                    >
                        <FormControl fullWidth>
                            <NativeSelect
                                defaultValue={
                                    data.rolesName
                                        ? data.rolesName === "admin"
                                            ? 20
                                            : data.rolesName === "manager"
                                            ? 30
                                            : data.rolesName
                                        : 10
                                }
