...
const OrderTableItem = ({ data, handleDeleteProduct }) => {
    console.log(data);
    return (
        <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
            ...
            <td className="flex p-5 items-center gap-0.5">
                ...
                <button onClick={()=> handleDeleteProduct(data.id)} className="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-red-600 flex item-center">
                    <svg
                        className=""
                        width="20"
                        height="20"
